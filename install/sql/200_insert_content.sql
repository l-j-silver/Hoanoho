...
(0, 'fhem_url_admin', '/fadmin', 'Frontend URL Admin', 'http://localhost:8082/admin', 'text', 'FHEM', 1),
(0, 'fhem_url_web', '', 'Frontend URL', 'http://localhost:8083/fhem', 'text', 'FHEM', 1),
(0, 'fhem_url_mobile', '/fmobile', 'Frontend URL Mobil', 'http://localhost:8084/phone', 'text', 'FHEM', 1),
(0, 'fhem_url_tablet', '/ftablet', 'Frontend URL Tablet', 'http://localhost:8085/tablet', 'text', 'FHEM', 1),
(0, 'fhem_url_webhook', '/webhook', 'Frontend URL Webhook', 'http://localhost:8088/webhook', 'text', 'FHEM', 1),
