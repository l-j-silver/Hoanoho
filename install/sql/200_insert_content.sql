...
(0, 'fhem_url_admin', '', 'FHEM Frontend URL Admin', 'http://localhost:8082/admin', 'text', 'FHEM', '1'),
(0, 'fhem_url_bk', 'http://localhost:8083/fhem', 'FHEM Backend URL', 'http://localhost:8083/fhem', 'text', 'FHEM', '1'),
(0, 'fhem_url_web', '', 'FHEM Frontend URL', 'http://localhost:8083/fhem', 'text', 'FHEM', '1'),
(0, 'fhem_url_mobile', '', 'FHEM Frontend URL Mobil', 'http://localhost:8084/phone', 'text', 'FHEM', '1'),
(0, 'fhem_url_tablet', '', 'FHEM Frontend URL Tablet', 'http://localhost:8085/tablet', 'text', 'FHEM', '1'),
(0, 'fhem_url_webhook', '', 'FHEM Frontend URL Webhook', 'http://localhost:8088/webhook', 'text', 'FHEM', '1'),
