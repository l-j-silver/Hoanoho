                    ...
                    while ($block = mysql_fetch_object($result)) {
                        ...
                        print("<div id=\"block-".$block->id."\">");
                            if($block_meta->iconid != -1)
								print("<div class=\"icon\" id=\"headline_icon\" style=\"background-image: url('helper-client/datacontroller.php?cmd=getimage&id=".$block_meta->iconid."')\"></div><div id=\"headline\">".$block_meta->title."</div><div id=\"headline_type\">".displayBlockTypes($block_meta->type)."</div><div id=\"headline_action\"><a href=\"#\" class=\"deleteBlockButton\" title=\"Bereich löschen\"><img src=\"./img/delete.png\"></a>&nbsp;&nbsp;<a href=\"#\" class=\"newRowButton\" title=\"Gerät hinzufügen\"><img src=\"./img/add.png\"></a></div>");
                            else
