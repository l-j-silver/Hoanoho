 ...
 *
 + HOANOHO:
 * Customized variant to support SHA512 as a workaround for HAproxy authentication
 */
    ...
    function password_hash($password, $algo, array $options = array()) {
        ...
        switch ($algo) {
            case PASSWORD_SHA512:
                ...
                $hash_format = sprintf("$6\$rounds=%02d$", $cost);
                // The expected length of the final crypt() output
                $resultLength = 114 + strlen($cost);
                break;
